...
```{r setup, include=FALSE, cache=TRUE, cache.rebuild=TRUE }
knitr::opts_chunk$set(echo = FALSE)
```

```{r, include=FALSE, echo = FALSE, cache=TRUE, cache.rebuild=TRUE }
library(httr)
library(fredr)
library(dplyr)
library(ggplot2)
...
```{r, include=FALSE, echo = FALSE,warning=FALSE, cache=TRUE, cache.rebuild=TRUE }
...
```{r, include=TRUE, echo = FALSE, cache=TRUE, cache.rebuild=TRUE }
#| title: Price
